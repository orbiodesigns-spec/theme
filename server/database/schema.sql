...
-- Run this entire file to reset/setup the database completely
-- WARNING: This will NOT delete existing data unless you uncomment the DROP DATABASE line.

CREATE DATABASE IF NOT EXISTS stream_theme_master;
